...
ALTER TABLE vendors
  ADD CONSTRAINT vendors_company_fk
  FOREIGN KEY (company_id) REFERENCES companies (id) ON DELETE CASCADE;

ALTER TABLE resources
  ADD CONSTRAINT resources_company_fk
  FOREIGN KEY (company_id) REFERENCES companies (id) ON DELETE CASCADE,
  ADD CONSTRAINT resources_vendor_fk
  FOREIGN KEY (vendor_id) REFERENCES vendors (id) ON DELETE SET NULL,
  ADD CONSTRAINT resources_template_fk
  FOREIGN KEY (resource_template_id) REFERENCES resource_templates (id) ON DELETE SET NULL,
  ADD CONSTRAINT resources_assigned_employee_fk
  FOREIGN KEY (assigned_to_employee_id) REFERENCES employees (id) ON DELETE SET NULL,
  ADD CONSTRAINT resources_paid_by_employee_fk
  FOREIGN KEY (paid_by_employee_id) REFERENCES employees (id) ON DELETE SET NULL;

ALTER TABLE resource_templates
  ADD CONSTRAINT resource_templates_company_fk
  FOREIGN KEY (company_id) REFERENCES companies (id) ON DELETE CASCADE,
  ADD CONSTRAINT resource_templates_vendor_fk
  FOREIGN KEY (vendor_id) REFERENCES vendors (id) ON DELETE SET NULL;
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_vendors_company_name ON vendors (company_id, lower(name));
...
CREATE INDEX IF NOT EXISTS idx_resources_assignee ON resources (company_id, assigned_to_employee_id);
CREATE INDEX IF NOT EXISTS idx_resources_vendor_id ON resources (vendor_id);
CREATE INDEX IF NOT EXISTS idx_resources_template_id ON resources (company_id, resource_template_id);
CREATE INDEX IF NOT EXISTS idx_resource_templates_company_id ON resource_templates (company_id);
CREATE INDEX IF NOT EXISTS idx_resource_templates_active ON resource_templates (company_id, is_active);
